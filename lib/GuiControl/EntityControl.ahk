class EntityControl extends GuiControlBase {
    ...
    DefaultCheckbox(entity, fieldName) {
        ...
        parameters := List.Clone(this.parameters)
        ...
        ctl.ToolTip := "When checked, the default value determined by various other factors will be used (and shown to the right if available). When unchecked, the value you set here will be used instead."
